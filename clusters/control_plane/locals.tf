locals {
  ...
  cluster_name           = "gh-control-plane"          # Must be unique for each DevOps Stack deployment in a single AWS account.
...
# TODO Consider if these values should be configurable as variables and set on the module call.
